...
//        return repository.findByAchievementTypeId(typeId);
//    }
//
...
//
//        existing.setAchievementTypeId(updated.getAchievementTypeId());
...
//        existing.setRequiredCoins(updated.getRequiredCoins());
//
